...
def common_ordered_words(best_match, sentence):
    ...
    # Loại bỏ các đoạn trống hoặc không hợp lệ
    paragraphs_best_match = [p for p in paragraphs_best_match if p]
    paragraphs_sentence = [p for p in paragraphs_sentence if p]
